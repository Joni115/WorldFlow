                ...
                <div class="td-container-wrap">
                    ...
                    <div class="td-panel-main-header">
                        ...
                        <div class="td-panel-header-desc">
                            <span class="td-panel-header-name">WorldFlow - Theme Panel</span>
                            <span class="td-panel-header-version">1.0</span>
                        </div>
                        <?php if ( td_util::get_option('td_banners_status') !== 'off' ) { ?>
                            <div class="td-admin-web-services">
                                <a class="td-services-link" title="Get free quote" href="#" target="_blank">
                                    <img class="td-services-img" alt="" src="#">
                                </a>
                            </div>
                        <?php } ?>
                    </div>
